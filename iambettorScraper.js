...
var daysToCheck = [
          "http://www.iambettor.com/football-predictions-" + moment().format("YYYY-MM-DD"),
          "http://www.iambettor.com/football-predictions-" + moment().add(1, "days").format("YYYY-MM-DD"),
          "http://www.iambettor.com/football-predictions-" + moment().add(2, "days").format("YYYY-MM-DD"),
          "http://www.iambettor.com/football-predictions-" + moment().add(3, "days").format("YYYY-MM-DD"),
    ];
...
function callback(error, response, body) {
    ...
    for(var x = 0; x < 1; x++) {
      ...
      console.log(url);
        ...
        var homeProbability = $(this).children().first().text().trim();
        var drawProbability = $(this).prev().children().first().text().trim();
